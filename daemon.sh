...
# Function to print out error message on what line the error occured.
...
# Installing Bitcoin dependencies.
echo -e "$YELLOW Installing BitCoin PPA...$COL_RESET"
if [ ! -f /etc/apt/sources.list.d/bitcoin.list ]; then
hide_output sudo add-apt-repository -y ppa:bitcoin/bitcoin
fi

# installing required packages to build requirements to build walets and other tools.
...
# Downloading and installing Berkley DB 4.8.30.
...
# Downloading and installing Berkeley DB 5.3.28
...
# Downloading and installing OpenSSL 1.0.2g
...
# Downloading and installing bls-signature v20181101
